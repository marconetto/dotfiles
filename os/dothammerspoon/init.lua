...
function cleanuberalert()
    return function()
        ...
        command =
        "tell application \"Übersicht\" to refresh widget id \"simplealert-widget-simplealert-coffee\""
...
hs.hotkey.bind({ "cmd" }, '`', function()
    hs.eventtap.keyStroke({ 'ctrl', 'cmd', "shift", "alt" }, '1')
end)
...
function battery_set_off()
    command =
    "tell application \"Übersicht\" to set hidden of widget id \"batterysimple-widget-batterysimple-coffee\" to true"
    hs.osascript.applescript(command)
...
function battery_set_on()
    command =
    "tell application \"Übersicht\" to set hidden of widget id \"batterysimple-widget-batterysimple-coffee\" to false"
    hs.osascript.applescript(command)
...
function toggle_battery_func()
    command =
    "tell application \"Übersicht\" to get hidden of widget id \"batterysimple-widget-batterysimple-coffee\""
...
function toggle_space_func()
    ...
    if space_on then
        command =
        "tell application \"Übersicht\" to set hidden of widget id \"appspace-widget-appspace-coffee\" to false"
    else
        command =
        "tell application \"Übersicht\" to set hidden of widget id \"appspace-widget-appspace-coffee\" to true"
    end
