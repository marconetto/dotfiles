...
# have zoxide to show the results in score order
export _ZO_FZF_OPTS="+s -e -m -0 --height=40% --layout=reverse --info=inline --border --margin=1 --padding=1 --select-1"
# -----------------------------------------------------------
